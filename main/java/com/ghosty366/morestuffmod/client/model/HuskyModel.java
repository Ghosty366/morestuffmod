...
public class HuskyModel<T extends HuskyEntity> extends EntityModel<T> {
	...
	public HuskyModel() {
        ...
        body.setTextureOffset(18, 14).addBox(-2.0F, -2.0F, -3.0F, 6.0F, 9.0F, 6.0F, 0.0F, true);

        upperBody = new ModelRenderer(this);
        upperBody.setRotationPoint(1.0F, 14.0F, -2.0F);
        setRotationAngle(upperBody, 1.5708F, 0.0F, 0.0F);
        upperBody.setTextureOffset(21, 0).addBox(-4.0F, -4.0F, -3.0F, 8.0F, 6.0F, 7.0F, 0.0F, true);

        leg0 = new ModelRenderer(this);
        leg0.setRotationPoint(2.5F, 16.0F, 7.0F);
        leg0.setTextureOffset(0, 18).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, 0.0F, true);

        leg1 = new ModelRenderer(this);
        leg1.setRotationPoint(-0.5F, 16.0F, 7.0F);
        leg1.setTextureOffset(0, 18).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, 0.0F, true);
        ...
        tail.setRotationPoint(1.0F, 13.0F, 8.25F);
